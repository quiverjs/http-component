...
var serializerHandler = abstractHandler('serializerHandler')
  .setLoader(simpleHandlerLoader('stream', 'streamable'))

export var multipartSerializeFilter =
streamFilter((config, handler) => {
  var { serializerHandler } = config
...
export var makeMultipartSerializeFilter = 
